...
<header class="clearfix <?php gt3_the_header_type(); ?>">
    ...
    <div class="contact_list">
    	<ul>
        <li><a href="mailto:info@studiodin.nl"><?php echo gt3_get_theme_option('public_email'); ?></a></li>
        <li><?php echo gt3_get_theme_option('phone'); ?></li>
        <li>Maassluisstraat 2, 1062 GD Amsterdam</li>
    	</ul>
    </div>
