...
function add_pb_to_content($content)
{
    ...
    if (!post_password_required() && $modulePrinted == false) {
...
if (!function_exists('showPortCats')) {
    function showPortCats($post_type_terms = "")
    {
        ...
        if ($count > 0) {
            ...
            $cape_list = '';
            $term_list .= '
			<span class="optionset_titel">Filter</span>
            <li class="grid_masonry_view" style="display:none;"></li>
            <li class="inline_view" style="display:none;"></li>
            <li class="' . $all_current . '"><a data-option-value="*" href="#filter">' . __('Alles', 'gt3_builder') . '</a></li>
            ';
