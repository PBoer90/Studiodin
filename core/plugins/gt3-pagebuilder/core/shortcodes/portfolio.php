...
class portfolio_shortcode
{
    public function register_shortcode($shortcodeName)
    {
        function shortcode_portfolio($atts, $content = null)
        {
			...
			// if ( is_front_page() ) {
			// 	$frontpage_style = "frontpage";
			// }

            include "includes/unlock.php";
            //$compile .= '<div class="banner"><img src="http://studiodin.nl/wp-content/uploads/Banner_NLPA_Website.jpg" alt="Nominatie Packaging awards 2016"></div>';
            $compile .= '<div class="portfolio_block ' . $view_type_class . '" id="'.$frontpage_style.'"><div class="portwrap '.($default_state == "Masonry/Grid" ? "now_grid_masonry_view" : "now_inline_view").' '.(($view_type == "Masonry" || $view_type == "Grid") ? "isotope_init isotope_preloader" : "").'">';
			$siteurl = "http://studiodin.nl/wp-content/uploads/2015/02/homepage_quote.png";
            //$compile .='<div class="quote_overlay"><img src="' . $siteurl . '"></div>';
   ...
   //  		// This is not the blog posts index
            ...
            while ($wp_query_in_shortcodes->have_posts()) : $wp_query_in_shortcodes->the_post();
                ...
                $post_hidden = get_field('verborgen');
                $post_hidden_value = '';
                if ($post_hidden == 'ja'){
                    $post_hidden_value = 'blurred';
                }
                ...
                if ($view_type == "Masonry" || $view_type == "Grid") {
                    ...
                    if ($post_hidden == 'nee' | $post_hidden == ''){
					if ( is_front_page() ) {
    				$tooltip ='
                        <div class="port_icons">
                            <ul>
                                <li id="port_zoom"><a href="' . $featured_image[0] . '" rel="prettyPhoto"></a></li>
                            </ul>
                        </div>
                        <div class="tooltip">
                            <a class="portfolio_item_title" href="'.get_permalink().'"><h4>'.get_field('onderwerp').'</h4></a>
                            <span>'. get_field('klant') .'</span>
                        </div>
                    ';
					// Jquery
					} else {
                    ...
                    $tooltip = '
                        <div class="unlock">
                            <a class="unlock_button" href="#">Toon item</a>
                        </div>
                        <div class="port_icons">
                            <ul>
                                <li id="port_zoom"><a href="' . $featured_image[0] . '" rel="prettyPhoto"></a></li>
                    ...
                    $compile .= '
                        <div data-category="' . $echoallterm . '" class="' . $echoallterm . ' element portfolio_item item ' . $post_hidden_value . '">
                            <div class="innerpadding"><div class="portfolio_item_img featured_item_fadder">
									' . $tooltip . '
                                    <a ' . $target . ' href="' . $linkToTheWork . '" class="image_link">
