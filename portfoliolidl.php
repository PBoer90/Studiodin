...
class portfolio_shortcode
{
    public function register_shortcode($shortcodeName)
    {
        function shortcode_portfolio($atts, $content = null)
        {
    		...
    		$compile .='<div class="quote_overlay"><img src="http://studiodin.nl/nieuw/wp-content/uploads/2015/02/homepage_quote.png"></div>';
			// Jquery
			} else {
					...
					$tooltip = '
						<div class="port_icons">
							<ul>
								...
								<li id="port_link"><a href="'.get_permalink().'"></a></li>
							</ul>
						</div>
						<div class="tooltip">
							<a class="portfolio_item_title" href="'.get_permalink().'"><h4>'.get_the_title().'</h4></a>
