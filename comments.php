...
<div id="comments">
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('.temp_submit_comment').html('<div class=\"send_this_comment shortcode_button btn_small btn_type5\"><span class=\"ico_cont\"><span class=\"ico_fader\"></span><i class=\"ico_this icon-share-alt\"></i></span><span class=\"btn_text\">" . __('Verstuur', 'theme_localization') . "</span></div>');
