...
jQuery(document).ready(function ($) {
    ...
    jQuery('.temp_submit_cf7').html('<div class="shortcode_button btn_small btn_type5"><span class="ico_cont"><span class="ico_fader"></span><i class="ico_this icon-share-alt"></i></span><span class="btn_text">Verstuur</span></div>');
